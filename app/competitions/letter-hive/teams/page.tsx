...
export default function LetterHiveTeams() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#faf8f5] via-[#f5ead8] to-[#faf8f5] flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-xl p-10 max-w-xl w-full mx-auto">
        <h1 className="text-3xl sm:text-4xl font-bold text-center text-[#d8a355] mb-8">خلية الحروف</h1>
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full border border-[#d8a355] rounded-lg px-4 py-3 focus:outline-none focus:border-[#c89547] text-right"
            />
          </div>
          <div className="mb-8">
